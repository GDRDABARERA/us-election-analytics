 ...
 $.ajax({   
	    ...
	    var data =  [
                        ...
                        var config = {
                          x : "Date",
                          charts : [
                            {type: "line",  y : "Rate", color: "Candidate",colorDomain:["TRUMP","CLINTON","BERNIE","CRUZ","RUBIE"], colorScale:["#ffcc00","#00e6e6","#d966ff","#ace600","#b30047"],tooltip: {"enabled":true, "color":"#e5f2ff", "type":"symbol", "content":["News1","News2","News3"], "label":true}}
                          ],
                          width: wit*0.85,
                          height: hight*0.75,
                          xFormat:"%d/%m/%Y",
